#requires -version 3
# 슈퍼로봇대전 컴플리트 박스 한글패치 v0.10.5 (제2차 + 제3차 + EX 전체) 적용 엔진
...
$patch   = Join-Path $root 'srwcb-second-third-ex-korean-v0.10.5.xdelta'

$T1NAME  = 'Super Robot Taisen Complete Box (Track 1).bin'
$T2NAME  = 'Super Robot Taisen Complete Box (Track 2).bin'
$OUTNAME = 'Super Robot Taisen Complete Box Korean v0.10.5 (Track 1).bin'
$CUENAME = 'Super Robot Taisen Complete Box Korean v0.10.5.cue'

$EXP_SRC   = '3f25650b588774d55c3bbb5b771779beab408eaca020e9a622133ade323a0f94'
$EXP_OUT   = 'd71bf82bf23652e08e1735774069a107582f1b355d306a8833030a1848de87a7'
$EXP_PATCH = 'd4f45bc2210f9f8f4c6a4595e35062192ae884daa0037db7f67e7f8a013890f7'
...
try {
    Write-Host ''
    Write-Host '============================================================'
    Write-Host '   슈퍼로봇대전 컴플리트 박스 한글패치 v0.10.5'
    Write-Host '   (제2차 + 제3차 + EX 전체)'
    Write-Host '============================================================'
    Write-Host ''

    if (-not (Test-Path -LiteralPath $xdelta)) { Fail "xdelta.exe 가 없습니다. 패치 파일들을 한 폴더에 함께 두세요." }
    if (-not (Test-Path -LiteralPath $patch))  { Fail "srwcb-second-third-ex-korean-v0.10.5.xdelta 가 없습니다." }
