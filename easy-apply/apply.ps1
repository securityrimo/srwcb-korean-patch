#requires -version 3
# 슈퍼로봇대전 컴플리트 박스 한글패치 v0.9.4 (제2차 전체 + 제3차 전체) 적용 엔진
...
$patch   = Join-Path $root 'srwcb-second-third-korean-v0.9.4.xdelta'

$T1NAME  = 'Super Robot Taisen Complete Box (Track 1).bin'
$T2NAME  = 'Super Robot Taisen Complete Box (Track 2).bin'
$OUTNAME = 'Super Robot Taisen Complete Box Korean v0.9.4 (Track 1).bin'
$CUENAME = 'Super Robot Taisen Complete Box Korean v0.9.4.cue'

$EXP_SRC   = '3f25650b588774d55c3bbb5b771779beab408eaca020e9a622133ade323a0f94'
$EXP_OUT   = 'f721ea6f95f8b529d71a9b48246f76ff3b565d4cbf87d799b03b3078f4e7e883'
$EXP_PATCH = '242241ab4407acca8832ac7ffcd7d4566b8f93b83c902124d33461400f8a4f88'
...
try {
    Write-Host ''
    Write-Host '============================================================'
    Write-Host '   슈퍼로봇대전 컴플리트 박스 한글패치 v0.9.4'
    Write-Host '   (제2차 전체 + 제3차 전체)'
    Write-Host '============================================================'
    Write-Host ''

    if (-not (Test-Path -LiteralPath $xdelta)) { Fail "xdelta.exe 가 없습니다. 패치 파일들을 한 폴더에 함께 두세요." }
    if (-not (Test-Path -LiteralPath $patch))  { Fail "srwcb-second-third-korean-v0.9.4.xdelta 가 없습니다." }
